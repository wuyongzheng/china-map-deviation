...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=0.48\textwidth]{fxx-lc2.png}
\end{center}
...
I have spent most time here, but there is nothing to say about it because it's
simply trying different functions.
